...
xcodebuild archive -project testCI/testCI.xcodeproj -scheme testCI -configuration Release -archivePath archive/testCI.xcarchive CODE_SIGN_IDENTITY="iPhone Distribution: EaseMob Inc." PROVISIONING_PROFILE="testProfile"
